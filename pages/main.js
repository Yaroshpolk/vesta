    ...
    return function (selector, config) {
        ...
        var _controlClick = function (e) {
            if (e.target.classList.contains('slider__control')) {
                e.preventDefault();
                var direction = e.target.classList.contains('slider__control_position_right') ? 'right' : 'left';
                _transformItem(direction);
        ...
        var _refresh = function () {
            ...
            _sliderControlLeft = _mainElement.querySelector('.slider__control_position_left');
            _sliderControlRight = _mainElement.querySelector('.slider__control_position_right');
